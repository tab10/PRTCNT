...
def plot_k_vs_num_tubes(tube_length, num_configs, grid_size, dim, div_by_k0=True, legend=True, exclude_vals='',
    ...
    def fill_fraction_tubes(x, orientation, tunneling, grid_size, dim):
        ######
        random_2d_15 = {'0': 0, '10': 2.04, '20': 4.04, '30': 6.15, '40': 8.22, '50': 10.06, '60': 12.21, '70': 14.23,
        ...
        random_3d_15 = {'0': 0, '1250': 2.91, '2500': 5.76, '3750': 8.63, '5000': 11.43, '6250': 14.15, '7500': 16.93,
        ...
        ######
        random_2d_10 = {'0': 0, '14': 1.95, '30': 4.2, '45': 6.29, '58': 8.23, '75': 10.58, '88': 12.32, '102': 14.19,
        ...
        ######
        random_2d_20 = {'0': 0, '8': 2.02, '15': 4.09, '23': 6.25, '30': 8.02, '39': 10.55, '46': 12.14, '53': 14.28,
