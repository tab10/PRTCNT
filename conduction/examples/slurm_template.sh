...
# for local mac/linux
#mpirun -np 2 python /Users/tim/Documents/PycharmProjects/conduction/conduction/mpi_run.py --dim 3 --orientation random --num_tubes 10 --tube_length 10 --gen_plots True --rules_test False --timesteps 15000 --num_walkers 60000 --model kapitza --grid_size 30 --prob_m_cn 0.5
