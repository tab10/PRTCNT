...
# for local mac/linux
#mpirun -np 2 python /Users/tim/PycharmProjects/conduction/conduction/mpi_run.py --dim 2 --orientation random --num_tubes 10 --tube_length 10 --gen_plots True --rules_test True --timesteps 15000 --num_walkers 500 --model kapitza --grid_size 30 --prob_m_cn 0.0
