...
def sim_2d_onlat_constant_flux(grid_size, tube_length, tube_radius, num_tubes, orientation, timesteps, save_loc_data,
    ...
    hot_walker_master, cold_walker_master, H, xedges, yedges = randomwalk_routine_2d_serial(grid,
                                                                                            grid_range, timesteps,
                                                                                            save_loc_data, quiet,
                                                                                            save_loc_plots, bins,
                                                                                            plot_save_dir,
                                                                                            walker_plot_save_dir,
                                                                                            walker_data_save_dir,
                                                                                            gen_plots, kapitza,
...
def randomwalk_routine_2d_serial(grid, grid_range, tot_time, save_loc_data, quiet, save_loc_plots, bins, plot_save_dir,
    ...
    for i in range(tot_time):
        if (i % 100) == 0 and (i > 1):
            ...
            dt_dx, heat_flux, dt_dx_err, k, k_err, r2 = analysis.check_convergence_2d_onlat(H, cur_num_walkers,
                                                                                            grid.size, i)
    ...
    return hot_walker_master, cold_walker_master, H, xedges, yedges
