...
def sim_2d_onlat(grid_size, tube_length, num_tubes, orientation, timesteps, save_loc_data,
    ...
    analysis.final_conductivity_2d_onlat(i * 2, temp_gradient_x, grid.size, timesteps, gradient_cutoff, gradient_avg,
                                         gradient_std, k_convergence_err, num_tubes, save_dir, k_convergence_val)
