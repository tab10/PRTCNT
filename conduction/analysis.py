...
def final_conductivity_2d_onlat(num_walkers, temp_gradient_x, grid_size, timesteps, gradient_cutoff, slope,
                                gradient_err, k_err, num_tubes, cur_dir, k_convergence_val):
